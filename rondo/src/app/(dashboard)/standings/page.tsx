...
function LeagueHero() {
  return (
    <div className="rounded-[20px] overflow-hidden border border-border bg-gradient-to-r from-[#10301d] to-[#0f1b13] relative">
      ...
      <div className="relative p-[26px_28px] flex items-center gap-6 flex-wrap">
        {/* League crest */}
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2.5 flex-wrap">
            <h1 className="font-heading font-black text-[28px] tracking-[-0.6px] leading-none">
              Sunday City League
            </h1>
        ...
        <div className="ml-auto flex gap-[26px] items-center">
...
export default function StandingsPage() {
  return (
    <div className="p-[28px_30px_44px] max-w-[1240px] mx-auto">
      ...
      <div className="grid grid-cols-[1fr_340px] gap-[22px] mt-[22px] items-start">
