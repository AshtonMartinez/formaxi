...
function ProfileHero() {
  return (
    <div className="rounded-[20px] overflow-hidden border border-white/[0.08]">
      {/* Cover */}
      <div className="h-[120px] bg-gradient-to-r from-[#10301d] to-[#13202e] relative">
        <div
      ...
      {/* Profile info */}
      <div className="px-7 pb-6 bg-surface flex items-end gap-5 flex-wrap">
        ...
        <div className="pb-1">
          <div className="flex items-center gap-2.5 flex-wrap">
            <h1 className="font-heading font-black text-[27px] tracking-[-0.5px]">
              Sam Rivera
            </h1>
        ...
        <Button variant="secondary" size="md" className="ml-auto mb-1.5">
          Edit profile
        </Button>
      </div>
    </div>
    ...
    <Card>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-[13px] p-3 bg-elevated rounded-xl">
          <Avatar initials="RF" color="#1f9a52" size="md" />
        ...
        {/* Tuesday 5s */}
        <div className="flex items-center gap-[13px] p-3 bg-elevated rounded-xl">
          <Avatar initials="T5" color="#06b6d4" size="md" />
          <div className="flex-1">
...
export default function ProfilePage() {
  return (
    <div className="p-[28px_30px_44px] max-w-[1100px] mx-auto">
      <ProfileHero />
      ...
      {/* Details grid */}
      <div className="grid grid-cols-2 gap-[18px] mt-[18px] items-start">
        <AccountDetails />
        <MyTeams />
      </div>
    </div>
